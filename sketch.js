...
function preload(){
  pikachu_running =loadAnimation("pikachurun1.png","pikachurun2.png");
  pikachu_collided=loadImage("pikachu_collided.png");
...
pikachu.addAnimation("run" ,pikachu_running);
pikachu.addAnimation("collided",pikachu_collided);
pikachu.setCollider('circle',0,0,100);
pikachu.scale = 0.3;
...
fill("black")
  ...
  if (gameState===PLAY){
    ...
    ground.velocityX = -(6 + 3*score/100);
  pikachu.changeAnimation("run",pikachu_running)
    if(keyDown("space") && pikachu.y>=416 ) {
